				...
				<div className="max-w-[1100px] mx-auto">
					<div className="text-center mb-14">
						...
						<p className="font-sans text-[15px] text-[#666] max-w-[500px] mx-auto">
							Whetstone uses Claude to deliver Socratic, scenario-based prep that adapts to your knowledge gaps in real time.
						</p>
					</div>
				...
				<div className="max-w-[680px] mx-auto">
					...
					<div className="space-y-6 font-serif text-[18px] text-[#ccc] leading-[1.7]">
						...
						<p>
							...
							<span className="text-[#F5B800] font-semibold">AI-native certification platform</span>. Whetstone doesn&rsquo;t quiz you — it{" "}
