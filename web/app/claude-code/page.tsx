...
export const metadata: Metadata = {
	title: "Whetstone — Pass the Anthropic Claude Code certification",
	description:
			...
			<nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-[#1a1a1a]">
				<div className="max-w-[1100px] mx-auto px-6 h-14 flex items-center justify-between">
					<Link href="/" className="flex items-center gap-3">
						...
						<span className="font-sans text-[13px] font-medium text-[#888] tracking-[0.04em]">Whetstone</span>
					</Link>
			...
			<section className="pt-36 pb-20 px-6">
				<div className="max-w-[760px] mx-auto text-center">
					...
					<p className="font-serif text-[18px] text-[#888] leading-[1.6] mb-9 max-w-[560px] mx-auto">
						Whetstone gives you the question bank, the mock exam, and the per-domain dashboard that tells you exactly where you're weak.
					</p>
				...
				<div className="max-w-[820px] mx-auto">
					<div className="mb-10">
						...
						<p className="font-sans text-[14px] text-[#888]">
							Notes from a recent passer. We baked these into how Whetstone drills.
						</p>
					</div>
			...
			<section className="py-24 px-6 border-t border-[#1a1a1a]">
				<div className="max-w-[680px] mx-auto text-center">
					...
					<p className="font-sans text-[15px] text-[#888] mb-8 max-w-[460px] mx-auto">
						720 is the pass line. 950 is when you stop drilling and book the exam. Whetstone tells you which line you're on.
					</p>
					<Link
						href="/claude-code/quiz"
			...
			<footer className="py-10 px-6 border-t border-[#1a1a1a]">
				<div className="max-w-[1100px] mx-auto flex items-center justify-between flex-wrap gap-4">
					<Link href="/" className="flex items-center gap-2">
						...
						<span className="font-sans text-[12px] text-[#555]">Whetstone</span>
					</Link>
