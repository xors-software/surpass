// Client-side auth helpers. Surpass now defers identity to api.xors.xyz
// (see lib/xors.ts) — these helpers wrap the small Surpass API surface
...
// Recovery codes only ever apply to local Surpass accounts; xors-side
