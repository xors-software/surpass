...
function buildSystemPrompt(courseName: string, materials: CourseMaterial[]): string {
	...
	return `You are Whetstone, an AI tutor for the course "${courseName}". You help students understand the course materials through clear explanation and Socratic questioning.
